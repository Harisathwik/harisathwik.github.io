...
module ExternalPosts
  class ExternalPostsGenerator < Jekyll::Generator
    ...
    def create_document(site, source_name, url, content, src = {})
      ...
      doc.data['feed_content'] = ''
      plain_text = Nokogiri::HTML(content[:summary].to_s).text.gsub(/\s+/, ' ').strip
      doc.data['description'] = plain_text.length > 200 ? plain_text[0..197] + '...' : plain_text
